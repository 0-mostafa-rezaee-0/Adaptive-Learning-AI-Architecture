...
\subsection{Chosen Approach and Rationale}\label{subsec:chosen-approach}
...
\subsection{Component Specifications}\label{subsec:component-specs}

\subsubsection{Retrieval Layer}\label{subsubsec:retrieval-layer}
...
\subsubsection{Deliverables}\label{subsubsec:m1-deliverables}
\begin{itemize}
...
\subsubsection{Acceptance Criteria}\label{subsubsec:m1-acceptance}
\begin{itemize}
...
\subsection{Milestone 2 (Weeks 3--4): Cross-Encoder Reranking \& Video/PDF Segmentation}\label{subsec:milestone-2}
...
\section{Deliverables per Milestone}\label{sec:deliverables}

\subsection{Milestone 1: RAG Baseline}\label{subsec:deliverable-milestone-1}
...
\subsection{Milestone 2: Reranking \& Segmentation}\label{subsec:deliverable-milestone-2}
